...
def time_to_merger(m1,m2,inc,e0,f_0,beta_15,beta_25,sigma):
    ...
    tm = (5/256* M/eta * 1/(v_init)**8*calculate_T(v_init, v_init, e0, eta, beta_15,beta_25,sigma))
...
def BBHx_response_direct(params,freqs,f_high,T_obs,TDIType,TDIversion=1,logging=False):
    '''
